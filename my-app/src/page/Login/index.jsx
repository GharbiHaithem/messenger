...
const Login = ({socket}) => {
  ...
  return (
    <div className='w-[80%] md:w-[80%] mx-auto h-[100vh]  bg-slate-50 md:bg-transparent '>
<div className="flex w-[70%]   mx-auto h-[400px]">
<form  onSubmit={formik.handleSubmit} className='flex items-start p-[30px] flex-col justify-center w-full md:w-[60%] md:rounded-l-2xl  rounded-r-none  bg-slate-50 gap-[10px]   mt-[100px]'>
    ...
    <button type="submit"  className="bg-orange-300 mx-auto md:mx-0 text-white hover:bg-white  shadow-sm hover:text-orange-300 p-2 rounded-lg text-sm">
  Se Connecter
</button>
